...
class NAS:
    ...
    def search(self, train_x, train_y, valid_x, valid_y, metadata):
        ...
        for epoch in range(self.epochs):
            ...
            train_acc, train_obj = _train(train_loader, model, criterion_smooth, optimizer, bin_op, scheduler, epoch, self.grad_clip, self.report_freq) if self.image else train(train_loader, model, criterion, optimizer, bin_op, scheduler, self.report_freq)
            ...
            if best_accuracy < valid_acc:
                ...
                saved_model = model
            print('train_acc {}, valid_acc {}, time {}'.format(train_acc, valid_acc, show_time(average_epoch_t * (self.epochs - epoch))))
